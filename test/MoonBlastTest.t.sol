...
contract MoonTestBlast is Test{
    ...
    function testBlastCreateFactory()public{
        ...
        cfg.dbrFarm = dbrFarm;
        cfg.nft = address(fr);
        cfg.uniswapV3Router = address(router);
    ...
    function testBlastDaiCreatePool()public{
        ...
        rules[0] = IMoonPool.InputRule(USDT,100,200,50,10000,50,10000,50,10000,5,200,100);
        rules[1] = IMoonPool.InputRule(USDC,110,190,100,5000,50,10000,200,9000,10,300,100);
        rules[2] = IMoonPool.InputRule(OP,100,200,50,10000,50,10000,50,10000,5,200,10000);
    ...
    function testBlastDaiWithdraw()public{
        testBlastDaiDeposit();
        vm.startPrank(user1);
    ...
    function testBlastInputDAI1()public{
        testBlastDaiDeposit();
    ...
    function testBlastInputDAI2()public{
        testBlastDaiDeposit();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastInputDAI3()public{
        testBlastDaiDeposit();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastGainDai1()public{
        testBlastInputDAI1();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastGainDai2()public{
        testBlastInputDAI2();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastGainDai3()public{
        testBlastInputDAI3();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastUSDTCreatePool()public{
        ...
        IMoonPool.InputRule[] memory rules = new IMoonPool.InputRule[](3);
        rules[0] = IMoonPool.InputRule(USDC,100,200,50,10000,50,10000,50,10000,5,200,100);
        rules[1] = IMoonPool.InputRule(OP,110,190,100,5000,50,10000,200,9000,10,300,3000);
        rules[2] = IMoonPool.InputRule(WETH,100,200,50,10000,50,10000,50,10000,5,200,500);
    ...
    // function testBlastUSDTStart()public{
    //     testBlastUSDTCreatePool();
    //     vm.startPrank(owner);
    ...
    function testBlastUSDTDeposit()public{
        testBlastUSDTCreatePool();
        // testBlastCreatePool();
        vm.startPrank(user1);
        IERC20(USDT).approve(address(moon),100000 *10**6);
    ...
    function testBlastUSDTWithdraw()public{
        testBlastUSDTDeposit();
        vm.startPrank(user1);
    ...
    function testBlastInputUSDT1()public{
        testBlastUSDTDeposit();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
        ...
        para.amount = 100000*10**6;
        para.minReturnAmount = 100000*10**6;
        para.falgs = 4;
        para.deadline = 1806855972;
        para.mask = 0x4481f3b2a39e0be4ddbe366390d3aa160dd14cc8c982f458b5b0ccd8c5e2ea67;
        para.data = data;
        para.signature = hex'd3638d9d3fb31856efeceec74215f4abfc238017f3f18edf19d7826eb009367255b919a7beaad44a959281bdb4f8e847a035faca721a421f348ce4da6897ec171c';
        moon.input(0,para);
    ...
    function testBlastInputUSDT2()public{
        testBlastUSDTDeposit();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastInputUSDT3()public{
        testBlastUSDTDeposit();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastGainUSDT1()public{
        testBlastInputUSDT1();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
        ...
        para.amount = 100000*10**6;
        para.minReturnAmount = 95000*10**6;
        para.falgs = 4;
        para.deadline = 1806855972;
        para.mask = 0x4481f3b2a39e0be4ddbe366390d3aa160dd14cc8c982f458b5b0ccd8c5e2ea67;
        para.data = data;
        para.signature = hex'ae6b840da202ae566c9e0b1c33675257444249523101a12e032114a30117ebd33b0706eda99af96bee81fa0fb63b9d21c44a90515ded8df1a2c2a9a82f724de51c';
        // console.log(IERC20(DAI).balanceOf(address(moon)));
        moon.gain(1,para);
        assertEq(moon.poolInfo().pendingValue,0);
    ...
    function testBlastGainUSDT2()public{
        testBlastInputUSDT2();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
    ...
    function testBlastGainUSDT3()public{
        testBlastInputUSDT3();
        vm.startPrank(developer);
        MoonPool.SignatureParams memory para;
